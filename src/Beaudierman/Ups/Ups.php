...
class Ups {
     ...
     * @return string
     * */
    private function buildPackages($options) {
        //dd($options);
        $packages = array();
    ...
    private function parseResult() {
        ...
        foreach ($simplified as $key => $value) {
            ...
            if ($this->negotiated_rates && $service->NegotiatedRates && $service->NegotiatedRates->NetSummaryCharges->GrandTotal->MonetaryValue) {
